<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="footer-top-area">
    ...
    <!-- Slider -->
    <script type="/res/site/text/javascript" src="/res/site/js/bxslider.min.js"></script>
	<script type="/res/site/text/javascript" src="/res/site/js/script.slider.js"></script>
  </body>
</html>